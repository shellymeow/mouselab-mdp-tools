...
def meta_controller(W_low, W_high, TREE, INIT, HIGH_COST=1, LOW_COST=1, SWITCH_COST=0, SEED=None, num_episodes=100, term_belief=False, log=False, init_func=None, disable_meta=False, exact_seed=False, cost_function="Basic", ground_truths = None):    
    ...
    #for truth in ground_truths:
        ...
        if SEED is not None:
            if not exact_seed:
                env = MetaControllerMouselab(TREE, INIT, term_belief=term_belief, high_cost=HIGH_COST, low_cost=LOW_COST, seed=1000*SEED + i, simple_cost=simple_cost)
            else:
                env = MetaControllerMouselab(TREE, INIT, term_belief=term_belief, high_cost=HIGH_COST, low_cost=LOW_COST, seed=SEED + i, simple_cost=simple_cost)
        else: 
            env = MetaControllerMouselab(TREE, INIT, term_belief=term_belief, high_cost=HIGH_COST, low_cost=LOW_COST, simple_cost=simple_cost)
...
def trace(W, TREE, INIT, HIGH_COST=1, LOW_COST=1, SWITCH_COST=0, SEED=0, term_belief=False, disable_meta=False, cost_function="Basic"):
    ...
    env = MetaControllerMouselab(TREE, INIT, term_belief=term_belief, high_cost=HIGH_COST, low_cost=LOW_COST, seed=SEED, simple_cost=simple_cost)
